...
//        return vo;
    ...
    public void paySuccess(String outTradeNo) {
        ...
        //用过websocket客户端浏览器推送消息 type orderId content
        Map map = new HashMap();
    ...
    public PageResult pageQuery4User(int page, int pageSize, Integer status) {
        ...
        //分页条件查询
        List<Orders> pages = orderMapper.pageQuery(ordersPageQueryDTO);
        ...
        return new PageResult(pages.size(), list);
    }
